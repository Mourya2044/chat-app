...
export default function Sidebar() {
  ...
  return (
    <div className="w-72 bg-card border-r border-border flex flex-col h-full">
      ...
      {/* Tab switcher */}
      <div className="m-3">
        <Tabs value={tab} onValueChange={setTab} defaultValue="chatrooms">
      ...
      {/* Chatrooms tab */}
      <TabsContent value="chatrooms" className="flex-1 overflow-y-auto px-2 mt-0">
        ...
        {showNewRoom && (
          <form onSubmit={createRoom} className="mb-2 p-3 bg-muted rounded-lg space-y-2">
            <Input 
              size="sm" 
      ...
      {/* DMs tab */}
      <TabsContent value="dms" className="flex-1 overflow-y-auto px-2 mt-0">
        {/* Search */}
